    ...
    <header class="header">
        <section class="w section__inner ">
            ...
            <ul class="top_nav clearfix">
                ...
                <li class="left"><a href="javascript:;" title="客户端">客户端</a></li>
                <li class="left"><a href="javascript:;" title="音乐号">音乐号</a></li>
                <li class="left"><a href="javascript:;" title="VIP">VIP</a></li>
            </ul>
            <ul class="top_subnav clearfix">
                <li class="left"><a href="javascript:;" title="首页">首页</a></li>
                <li class="left"><a href="javascript:;" title="歌手">歌手</a></li>
                <li class="left"><a href="javascript:;" title="专辑">专辑</a></li>
                <li class="left"><a href="javascript:;" title="排行榜">排行榜</a></li>
                <li class="left"><a href="javascript:;" title="分类歌单">分类歌单</a></li>
                <li class="left"><a href="javascript:;" title="电台">电台</a></li>
                <li class="left"><a href="javascript:;" title="MV">MV</a></li>
                <li class="left"><a href="javascript:;" title="数字专辑">数字专辑</a></li>
                <li class="left"><a href="javascript:;" title="票务">票务</a></li>
            </ul>
    ...
    <main class="main w">
        <div class="mod_data">
            ...
            <div class="data__cont">
                <h1 class="data__tit">舒缓R&B：一个人放松专用</h1>
        ...
        <div class="detail_layout clearfix">
            <div class="detail_layout__main ">
                <div class="mod_songlist">
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">1</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="There For You">There For You</a>
                                </span>
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">Troye Sivan</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">There For You </a></li>
                        <li class="songlist__list_time">03:41</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">2</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="雨好">雨好</a>
                                </span>
                            <div class="mod_list_menu" style="display:none">
                                <a href="javascript:;"><i class="mod_list_menus play"></i></a>
                                <a href="javascript:;"><i class="mod_list_menus add"></i></a>
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">陈鸿宇</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">一如年少摸样</a></li>
                        <li class="songlist__list_time">04:15</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">3</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Edgar Allan Poe'd Up">Edgar Allan Poe'd Up</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <div class="mod_list_menu" style="display:none">
                                <a href="javascript:;"><i class="mod_list_menus play"></i></a>
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">Smino / theMIND</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">Blkswn</a></li>
                        <li class="songlist__list_time">03:10</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">4</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="孤独患者">孤独患者</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <div class="mod_list_menu" style="display:none">
                                <a href="javascript:;"><i class="mod_list_menus play"></i></a>
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">陈奕迅</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">?</a></li>
                        <li class="songlist__list_time">04:32</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">5</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="伤">伤</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <i class="songlist__list songlist__list_mv"></i>
                            <div class="mod_list_menu" style="display:none">
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">李代沫</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">敏感者</a></li>
                        <li class="songlist__list_time">04:31</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">6</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="乌托邦《再创世纪》电视剧主题曲">乌托邦《再创世纪》电视剧主题曲</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <i class="songlist__list songlist__list_mv"></i>
                            <div class="mod_list_menu" style="display:none">
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">周柏豪</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">乌托邦</a></li>
                        <li class="songlist__list_time">03:59</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">7</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="We Don't Talk Anymore">We Don't Talk Anymore</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <i class="songlist__list songlist__list_mv"></i>
                            <div class="mod_list_menu" style="display:none">
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">Charlie Puth / Selena Gomez</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">Nine Track Mind</a></li>
                        <li class="songlist__list_time">03:37</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">8</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Time Swells">Time Swells</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <i class="songlist__list songlist__list_mv"></i>
                            <div class="mod_list_menu" style="display:none">
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">Caroline</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">Where's My Love</a></li>
                        <li class="songlist__list_time">03:58</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">9</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Love Yourself2016年AMA全美音乐奖最受欢迎流行/摇滚歌曲获奖歌曲">Love
                                        Yourself2016年AMA全美音乐奖最受欢迎流行/摇滚歌曲获奖歌曲</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <i class="songlist__list songlist__list_mv"></i>
                            <div class="mod_list_menu" style="display:none">
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">Justin Bieber</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;"> Purpose (Deluxe)</a></li>
                        <li class="songlist__list_time">03:53</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">10</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Foolish">Foolish</a>
                                </span>
                            <div class="mod_list_menu" style="display:none">
                                <a href="javascript:;"><i class="mod_list_menus play"></i></a>
                                <a href="javascript:;"><i class="mod_list_menus add"></i></a>
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">Shayne Ward</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">Obsession</a></li>
                        <li class="songlist__list_time">03:18</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">11</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Don't Let Me Down">Don't Let Me Down</a>
                                </span>
                            <i class="songlist__list songlist__list_du"></i>
                            <div class="mod_list_menu" style="display:none">
                                <a href="javascript:;"><i class="mod_list_menus play"></i></a>
                        ...
                        <li class="songlist__list_autor"><a href="javascript:;">Sabrina Claudio / Khalid</a></li>
                        <li class="songlist__list_zhuanji"><a href="javascript:;">Don't Let Me Down / All To You</a></li>
                        <li class="songlist__list_time">02:56</li>
                    </ul>
                    <ul class="songlist__list">
                        <li class="songlist__list_num">12</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="雨好">雨好</a>
                                </span>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">13</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Edgar Allan Poe'd Up">Edgar Allan Poe'd Up</a>
                                </span>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">14</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="孤独患者">孤独患者</a>
                                </span>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">15</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="伤">伤</a>
                                </span>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">16</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="乌托邦《再创世纪》电视剧主题曲">乌托邦《再创世纪》电视剧主题曲</a>
                                </span>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">17</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="We Don't Talk Anymore">We Don't Talk Anymore</a>
                                </span>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">18</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Time Swells">Time Swells</a>
                                </span>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">19</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Love Yourself2016年AMA全美音乐奖最受欢迎流行/摇滚歌曲获奖歌曲">Love
                                        Yourself2016年AMA全美音乐奖最受欢迎流行/摇滚歌曲获奖歌曲</a>
                    ...
                    <ul class="songlist__list">
                        <li class="songlist__list_num">20</li>
                        <li class="songlist__list_name">
                                <span class="songlist__songname_txt">
                                    <a href="javascript:;" title="Foolish">Foolish</a>
                                </span>
            ...
            <div class="detail_layout__other ">
                <div class="mod_about ">
                    ...
                    <div class="mod_cont">
                        <p>律动的音符萦绕耳边，掬一缕可以愉悦一整日。
                            轻快的旋律，慵懒迷醉的嗓音，随着律动呼吸，
                            让节奏渗入你心里的每个角落，放松愉悦所有紧张细胞。 听R&B音乐的那种舒适感，是其他音乐类型难以比肩的！
                            希望这些音乐可以带给你放松的感觉！</p>
                    </div>
